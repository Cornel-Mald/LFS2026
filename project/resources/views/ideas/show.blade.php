<x-layout title="Welcome">
    ...
    <div class="card mt-6 text-white p-6 rounded-lg bg-gray-800">
        ...
        <a href="/ideas/{{ $idea->id }}/edit"
            ckass="ounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Edit</a>
    </div>
</x-layout>
