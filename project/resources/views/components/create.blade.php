    ...
    <x-card class="max-w-400">
        <p>This is the create ideas page.</p>
    </x-card>
        ...
        <div class="col-span-full">
            ...
            <div class="mt-2">
                <textarea id="description" name="description" rows="3"
                    class="textarea w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6 @error('description') textarea-error @enderror"></textarea>
